...
> **Nota docente:** En cursos de 12 h, esta sesión puede extenderse con discusión de casos reales y mini‑debates.

---


## IA generativa y Prompting científico
...
> **Rol del profesor:** Experto en bioinformática y enseñanza computacional
> 
> **Propósito de la sesión:** Introducir el uso crítico y responsable de IA generativa como herramienta de apoyo al análisis bioinformático, enfocándose en el diseño de *prompts científicos* reproducibles y verificables.
...
- Formular **prompts científicos claros, estructurados y verificables**.
- Reconocer las **limitaciones y riesgos** de la IA generativa.
- Distinguir entre una pregunta vaga y una **especificación científica**.
- Utilizar IA como **asistente**, no como sustituto del razonamiento.

--------

- Comprenda qué es la IA generativa y cómo funciona a nivel conceptual.
- Distinga entre *prompting creativo* y *prompting científico*.
- Utilice la IA como herramienta de apoyo al razonamiento, no como sustituto del análisis.
- Reconozca qué tareas pueden y no pueden delegarse a una IA en bioinformática.


Mensaje clave a reforzar:
> **La IA no piensa por ti. Tú piensas y la IA asiste.**



## Marco conceptual: ¿qué es y qué no es la IA generativa?

### ✔ Qué **sí** es un modelo tipo GPT

- Un **modelo de lenguaje** entrenado para predecir texto probable.
- Útil para:
  - estructurar ideas
  - explicar conceptos
  - proponer planes de análisis

### ❌ Qué **no** es

- No razona biológicamente.
- No valida resultados.
- No sustituye análisis, experimentos ni interpretación humana.

Frase para clase:
> *Si una respuesta no la puedes verificar, no es un resultado científico.*



## Progresión de la sesión

Primero revisaremos conceptos a utilizar, después analizaremos **errores comunes**, luego construiremos el **marco conceptual** y finalmente estudiaremos **ejemplos correctos**.

> *En ciencia, aprender a detectar errores es tan importante como aprender a hacer las cosas bien.*
...
## Prompting creativo vs Prompting científico
...
# 🅐 Apéndice A — Prompting científico para futuros investigadores (Avanzado)

> **Carácter del apéndice:** material avanzado, recomendado para estudiantes con interés en investigación, tesis o análisis bioinformático profundo.
...
## Ejercicio — Análisis crítico de prompts
...
# 🧑‍🏫 Apéndice P — Notas para profesores (uso interno)

> ⚠️ **Este apéndice no debe compartirse con estudiantes antes de la evaluación.**

## P.1 Uso sugerido en clase

- El **glosario** debe trabajarse de forma dialogada, no como definiciones a memorizar.
- Los **anti‑ejemplos** funcionan mejor si el alumno identifica primero los errores antes de discutirlos.
- El **mini‑debate** es clave para fijar correlación vs causalidad.


## P.2 Evaluación

- El ejercicio de análisis de prompts evalúa **formulación del problema**, no respuestas de la IA.
- El Apéndice A puede usarse como:
  - material de profundización
  - referencia para proyectos
  - criterio extra para alumnos destacados


## P.3 Mensaje pedagógico clave

> *Formar científicos no es enseñar herramientas, sino enseñar a formular preguntas defendibles.*
